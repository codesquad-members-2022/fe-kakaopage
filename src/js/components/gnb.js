const createGnb = () => {
  ...
  <div class="gnb__inner">
    <ul class="gnb__list">
      ...
      <li data-category="webtoon" class="gnb__item">웹툰&#8729;<img src="static/icon/bmbadge_waitfree_black.svg" alt="" /></li>
      <li data-category="webnovel" class="gnb__item">웹소설&#8729;<img src="static/icon/bmbadge_waitfree_black.svg" alt="" /></li>
