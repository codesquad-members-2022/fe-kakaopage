export const mainBaneerData = {
    'home': [
        {   
            ...
            'tags': {'status': "up", 'type': '웹툰','views': '11.7만명'}    
        },
        {   
            'order': '2',
            'src': 'https://dn-img-page.kakao.com/download/resource?kid=yn7g7/hyF292TNMt/4XChRjVWahHf4ebIfh3NC1',
            'title': '던전리셋',
            'description': '하늘도 뚫어버릴 흙수저가 온다',
            'tags': {'status': "up", 'free': 'true', 'type': '웹툰','views': '72.8만명'}    
        },
        {   
            'order': '3',
