...
RofanGenre.prototype.setCarousel = function (getInterval) {
  const interval = getInterval();
  this.state.interval = interval;
};
RofanGenre.prototype.clearCarousel = function () {
...
RofanGenre.prototype.sortRanking = function (items) {
  return items.sort((i1, i2) => i2.rank - i1.rank);
};

RofanGenre.prototype.filterContent = function (webtoons, where, what) {
