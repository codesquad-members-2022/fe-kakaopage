...
ActionGenre.prototype.setCarousel = function (getInterval) {
  const interval = getInterval();
  this.state.interval = interval;
};
ActionGenre.prototype.clearCarousel = function () {
...
ActionGenre.prototype.sortRanking = function (items) {
  return items.sort((i1, i2) => i2.rank - i1.rank);
};

ActionGenre.prototype.filterContent = function (webtoons, where, what) {
...
ActionGenre.prototype.setup = async function () {
