...
const Mon_imageCardInfo = [
  {
    ...
    title: "8클래스 마법사의 회귀",
    info: [
      "image-card__comment__info-new hidden",
      "image-card__comment__info-update hidden",
      "image-card__comment__info-years hidden",
      "image-card__comment__info-icon",
    ],
    subscriber: "81.5만명",
  },
  {
    ...
    info: [
      "image-card__comment__info-new hidden",
      "image-card__comment__info-update hidden",
      "image-card__comment__info-years",
      "image-card__comment__info-icon",
    ],
    subscriber: "122.7만명",
  },
  {
    ...
    info: [
      "image-card__comment__info-new hidden",
      "image-card__comment__info-update",
      "image-card__comment__info-years hidden",
      "image-card__comment__info-icon",
    ],
    subscriber: "132만명",
...
const weeklyWebtoonDataInfo = [mon, tue, wed, thu, fri, sat, sun];
export { weeklyWebtoonDataInfo };
