const datas = {
  ...
  sectionContents: [
    [
          ...
          <div class="eventSlide" id="eventSlideId">
              <div class="eventSlideInfo">
                  <div class="slideMoveBtn">
                      <img src="/images/previous button.svg" alt="">
                      <img src="/images/next button.svg" alt="">
                  </div>
                  <div class="eventTitle">에스티오</div>
                  <div class="eventInfoWrap">
                      <div class="eventLeft">
                          <div class="eventStatusWrap">
                              <img src="/images/badge-bigthum-event.svg" alt="" class="eventStatus">
                          </div>
                          <img src="/images/ico-bigthum-wait.svg" class="clock"></img>
                          <div class="eventGenreInfo">웹툰</div>
                          <div class="eventSlash">|</div>
                          <img src="/images/ico-bigthum-person.svg" alt="" class="readCountEvent">
      ...
      <div class="waitForFreeWebtoon">
          ...
          <div class="contentWrap">
              <div class="content">
                  <div class="contentImageWrap">
                      <img src="/images/웹툰 _ 더 라이브7타 _ 21-24.png" class="contentImage">
                      <img src="/images/기다리면 무료.png" alt=""
                          class="contentImageStatus waitFreeImageStatus">
                  </div>
                  <div class="contentDetailWrap">
                      <div class="status">
                          <img src="/images/새 작품.svg" alt="" class="statusIcon">
                          <div class="contantTitle">에스티오</div>
                      </div>
      
                      <div class="synopsis">날 부른게... 당신입니까?</div>
                      <div class="followAndCreator">
                          <img src="/images/icon_read_count.png" alt="" class="readCount">
          ...
          <div class="dayRankingContentWrap">
              ...
              <div class="dayRankingImageWrap">
                  <img src="/images/궁귀검신.png" alt="" class="dayRankingImage">
                  <img src="/images/기다리면 무료.png" alt="" class="contentImageStatus waitFreeImageStatus">
              </div>
              <div class="dayRankingDataWrap">
                  <div class="statusAndTitle">
                      <div class="dayRankingStatus">
                          <img src="/images/새 작품.svg" alt="" class="dayRankingStatus">
                      </div>
      ...
      <div class="slideAd">
          <div class="slideBtn">
              <img src="/images/ic-paging-back-nor.svg" alt="">
          </div>
          <img src="/images/pkJfplo35eZ6KPVd803O11.jpg" alt="" class="slideAdImg">
          <div class="slideBtn">
              <img src="/images/ic-paging-next-nor.svg" alt="">
          </div>
      </div>
                  ...
                  <div class="eventSlide expectToonContent">
                      <div class="eventSlideInfo expectToonInfo">
                          ...
                          <div class="eventInfoWrap expectToonInfoWrap">
                              <div class="eventStatusWrap ">
                                  <img src="/images/badge-bigthum-event.svg" alt=""
                                      class="eventStatus expectStatus">
                              </div>
                              <img src="/images/ico-bigthum-wait.svg"
                                  class="clock expectToonClock"></img>
                              <div class="eventGenreInfo">웹툰</div>
                              <div class="eventSlash expectToonSlash">|</div>
                              <img src="/images/ico-bigthum-person.svg" alt=""
  ...
  eventContents: [
    {
      genre: "홈",
      title: "회귀자의 증권사 생활",
      imgsrc: "/images/소설 _ 회귀자의 증권사 생활 6타 _ 15-24.png",
      follow: 18.5,
    },
    {
      genre: "요일연재",
      title: "마법 아카데미의 육체파 천재",
      imgsrc: "/images/소설 _ 마법 아카데미의 육체파 천재 8타 _ 0-24.png",
      follow: 438.5,
    },
    {
      genre: "웹툰",
      title: "그 악녀가 검을 든 이유",
      imgsrc: "/images/소설 _ 그 악녀가 검을 든 이유 2타 _ 10-24.png",
      follow: 24.5,
    },
    {
      genre: "소년",
      title: "롱리브더킹",
      imgsrc: "/images/웹툰 _ 롱리브더킹 1타 _ 21-24.png",
      follow: 42.5,
    },
    {
      genre: "드라마",
      title: "8클래스 마법사의 회귀",
      imgsrc: "/images/웹툰 _ 8클래스 마법사의 회귀 0타 _ 21-23.png",
      follow: 18.8,
    },
    {
      genre: "로맨스",
      title: "학사재생",
      imgsrc: "/images/웹툰 _ 학사재생 9타 _ 0-24.png",
      follow: 17.5,
    },
    {
      genre: "로판",
      ...
      imgsrc:
        "/images/웹툰 _ 남주를 주웠더니 남편이 생겨버렸다 3타 _ 15-23.png",
      follow: 68.5,
    },
    {
      genre: "액션무협",
      title: "더 라이브",
      imgsrc: "/images/웹툰 _ 더 라이브7타 _ 21-24.png",
      follow: 27.4,
    },
    {
      genre: "BL",
